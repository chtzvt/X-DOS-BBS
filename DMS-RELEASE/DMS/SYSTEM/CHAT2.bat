@echo off
title DMS Chat (Room 2: Science, Technology)
color 17
...
:enterchat
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo ^%user% entered chat. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
...
cls
echo Welcome to Chatroom 1.
echo The topic here is "Science, Technology"
echo.
echo COMMANDS:
echo ***New messages do not appear automatically.*** 
echo !!!!!You must constantly refresh the chat session.!!!!!
...
echo type /termclear to remove any laggy strings of text you may see.
echo.
type "C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo.
echo ^%user% in Chat.
set /p MSG1=Message:
...
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo  ^%user% said: >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo  ^%MSG1% >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo  %time% %date% >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
goto chat

:leave
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo ^%user% left! >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM2.txt"
goto eof
