...
:enterchat
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo ^%user% entered chat. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo Welcome to Chatroom 1.
echo The topic here is "Random"
echo You may talk about whatever you like here.
echo.
echo COMMANDS:
...
echo.
echo COMMANDS:
echo New messages do not appear automatically. you must constantly refresh the chat session.
echo Type /q to exit.
echo type /r to refresh.
echo type /termclear to remove any laggy strings of text you may see.
echo.
type "C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo.
echo ^%user% in Chat.
set /p MSG1=Message:
...
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo  ^%user% said: >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo  ^%MSG1% >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo  %time% %date% >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
goto chat

:leave
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo ^%user% left! >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM.txt"
goto eof
