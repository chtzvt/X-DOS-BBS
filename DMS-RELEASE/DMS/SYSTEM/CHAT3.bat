@echo off
title DMS Chat (Room 3: Politics, World News)
color 17
...
:enterchat
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo ^%user% entered chat. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo Welcome to Chatroom 1.
echo The topic here is "Politics/World News"
echo.
echo COMMANDS:
...
echo type /termclear to remove any laggy strings of text you may see.
echo.
type "C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo.
echo ^%user% in Chat.
set /p MSG1=Message:
...
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo  ^%user% said: >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo  ^%MSG1% >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo  %time% %date% >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
goto chat

:leave
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo ^%user% left! >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
echo. >>"C:\DSOFT\DMS\MAILSERVER\CHATROOMS\CHATROOM3.txt"
goto eof
